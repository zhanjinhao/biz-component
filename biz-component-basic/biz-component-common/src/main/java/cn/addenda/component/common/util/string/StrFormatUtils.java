...
public class StrFormatUtils {
  ...
  public static String format(CharSequence template, Object... params) {
    ...
    if ((params == null || params.length == 0) || !StringUtils.hasText(template)) {
  ...
  public static String formatWith(String strPattern, String placeHolder, boolean decodeByte, Charset charset, Object... argArray) {
    if (!StringUtils.hasText(strPattern) || !StringUtils.hasText(placeHolder) || ArrayUtils.isEmpty(argArray)) {
      return strPattern;
    }
